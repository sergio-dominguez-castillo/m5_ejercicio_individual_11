package cl.bootcamp.ejercicioindividual11.view
...
import cl.bootcamp.ejercicioindividual11.components.MainTextField
import cl.bootcamp.ejercicioindividual11.components.Space
import androidx.compose.material3.SegmentedButtonDefaults
import androidx.compose.material3.Text
import androidx.compose.runtime.mutableStateListOf
import androidx.compose.runtime.remember
import androidx.lifecycle.ViewModel
import cl.bootcamp.ejercicioindividual11.components.MainButton
import cl.bootcamp.ejercicioindividual11.components.MainText
...
fun HomeView(viewModel: CalculateViewModel) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Ejercicio Individual 11", color = Color.White) },
